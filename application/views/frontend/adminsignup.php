        ...
        <!-- Registration form -->
          ...
          <div class="panel panel-flat">
            ...
            <div class="panel-body">
              <?php echo form_open_multipart('HomeController/admin_signup',['class'=>'associate-validation']);?>
              <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="email" name="email" id="email" placeholder="Enter your email address" class="form-control" onblur="cheq_e_mail(this);"/>
                  ...
                  <div class="col-md-4">
                        ...
                        <div class="form-group">
                         ...
                         <input type="text" class="form-control" placeholder="Enter your contact number" name="contact" id="number" maxlength="10" onkeypress="return isNumberKey(event)" />
